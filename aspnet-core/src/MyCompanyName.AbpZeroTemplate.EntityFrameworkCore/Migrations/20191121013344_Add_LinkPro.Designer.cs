...
namespace MyCompanyName.AbpZeroTemplate.Migrations
{
    ...
    [Migration("20191121013344_Add_LinkPro")]
    partial class Add_LinkPro
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Class.PbClass", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.DownloadEbook.PbDownloadEbook", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("PbEbookId");

                    b.HasKey("Id");

                    b.HasIndex("PbEbookId");

                    b.ToTable("PbDownloadEbooks");
                });

            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Ebook.PbEbook", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.LinkPro.PbLinkPro", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Oppinion.PbOppinion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.PriceUser.PbPriceUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Subject.PbSubject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.DownloadEbook.PbDownloadEbook", b =>
                {
                    b.HasOne("MyCompanyName.AbpZeroTemplate.Ebook.PbEbook", "PbEbookFk")
                        .WithMany()
                        .HasForeignKey("PbEbookId");
                });

            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.Ebook.PbEbook", b =>
                {
                    b.HasOne("MyCompanyName.AbpZeroTemplate.Class.PbClass", "PbClassFk")
                        .WithMany()
                        .HasForeignKey("PbClassId");

                    b.HasOne("MyCompanyName.AbpZeroTemplate.Place.PbPlace", "PbPlaceFk")
                        .WithMany()
                        .HasForeignKey("PbPlaceId");

                    b.HasOne("MyCompanyName.AbpZeroTemplate.Rank.PbRank", "PbRankFk")
                        .WithMany()
                        .HasForeignKey("PbRankId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MyCompanyName.AbpZeroTemplate.Status.PbStatus", "PbStatusFk")
                        .WithMany()
                        .HasForeignKey("PbStatusId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MyCompanyName.AbpZeroTemplate.SubjectEducation.PbSubjectEducation", "PbSubjectEducationFk")
                        .WithMany()
                        .HasForeignKey("PbSubjectEducationId");

                    b.HasOne("MyCompanyName.AbpZeroTemplate.Subject.PbSubject", "PbSubjectFk")
                        .WithMany()
                        .HasForeignKey("PbSubjectId");

                    b.HasOne("MyCompanyName.AbpZeroTemplate.TypeEbook.PbTypeEbook", "PbTypeEbookFk")
                        .WithMany()
                        .HasForeignKey("PbTypeEbookId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MyCompanyName.AbpZeroTemplate.TypeFile.PbTypeFile", "PbTypeFileFk")
                        .WithMany()
